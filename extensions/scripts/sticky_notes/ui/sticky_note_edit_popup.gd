# ==============================================================================
# Taj's QoL - Sticky Note Edit Popup
# Modal popup for editing sticky note title and icon
...
const LOG_NAME = "TajsQoL:StickyNoteEditPopup"

# Preload Icon Browser from Core
