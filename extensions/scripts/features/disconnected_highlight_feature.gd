# ==============================================================================
# Taj's QoL - Disconnected Highlight Feature
# Author: TajemnikTV
# Description: Highlights windows not connected to the main graph.
# ==============================================================================
extends Node
